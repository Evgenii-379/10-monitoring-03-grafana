# **Домашнее задание к занятию 14 «Средство визуализации Grafana»**-***Вуколов Евгений***
 
...
1. Отредактировал файл docker-compose.yml:
- Добавил проброс портов для:
...
2. При помощи команды docker compose up -d разварачиваю конфигурацию и добавляю в конфигурацию grafana источник prometheus

- ![scrin](https://github.com/Evgenii-379/10-monitoring-03-grafana/blob/main/Снимок%20экрана%202025-02-12%20214251.png)
...
user = jek_v79@mail.ru
password = ***********
from_address = jek_v79@mail.ru
from_name = Grafana
skip_verify = false 
...
- ![scrin](https://github.com/Evgenii-379/10-monitoring-03-grafana/blob/main/Снимок%20экрана%202025-02-14%20221937.png)
...
      "targets": [
        {
          "expr": "(node_filesystem_size_bytes{mountpoint=\"/\",fstype=\"ext4\"} - node_filesystem_avail_bytes{mountpoint=\"/\",fstype=\"ext4\"}) / 1024 / 1024\r\n",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
